...
Usage (from the project root, same as tools/pending_builds.py):
    python tools/bootstrap_creator.py <name>
"""
import asyncio
import re
import sys
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python tools/bootstrap_creator.py <name>")
        sys.exit(1)
